...
تیونینگ میتواند از طریق GUI وب یا با استفاده از BOS Toolbox و یا در فایل پیکربندی ``/etc/bosminer.toml`` تنظیم شود.
...
*psu_power_limit* می تواند مقادیر عددی (حداقل 100 و حداکثر 5000) را در اختیار داشته باشد و حداکثر توان PSU (در واحد وات) را برای سه هشبورد و بورد کنترل نشان می دهد.
...
برای انجام این کار برای دستگاههای متعدد به طور موازی میتوانید از نرمافزار
