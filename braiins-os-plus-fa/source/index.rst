...
این یک نسخه جزئی است که اشکالات جزئی مربوط به اتصالات استخر را برطرف می کند.

*  تمامی دستگاه‌ها

  * [bug fixes] اشکالات جزئی مربوط به اتصالات استخر

22.08
---------------------------

این یک نسخه اصلی است که BeagleBone Black Control Board را برای استفاده عمومی و حالت Hashrate Target را برای تنظیم خودکار آورده است.

*  سخت افزار Antminer X19

  * [feature] حالت Hashrate Target برای تنظیم خودکار
  * [improvement] منحنی های قدرت بهبود یافته برای S19j PRO و S19 PRO

*  سخت افزار Antminer X17

  * [feature] حالت Hashrate Target برای تنظیم خودکار
  * [improvement] پیش‌فرض‌های حد توان تنظیم‌شده برای خانواده Antminer X17

**توجه:** 

* محدودیت‌های توان پیش‌فرض برای خانواده X17 اکنون با محدودیت‌های توان موجودی بر اساس نوع دستگاه همسو شده‌اند. محدودیت توان پیش‌فرض قبلی 1700 وات، اکنون 2200 وات است، که میزان مصرف و خروجی نرخ هش را با مشخصات موجود بیشتر مطابقت می‌دهد.

* **مهم:** اگر در حال حاضر بسیاری از دستگاه های X17 را با محدودیت برق پیش فرض اجرا می کنید، این به روز رسانی باعث افزایش قابل توجهی در مصرف انرژی می شود. برای جلوگیری از آن، به سادگی می توانید محدودیت قدرت دستگاه های خود را کمی تغییر دهید (به عنوان مثال به 1710 وات) تا ارتقاء هیچ تغییر عمده ای ایجاد نکند.

* اگر Braiins OS+ را روی یک دستگاه استوک نصب می‌کنید یا از محدودیت قدرت تعریف‌شده توسط کاربر استفاده می‌کنید، این تغییر به هیچ وجه بر شما تأثیر نخواهد گذاشت.

22.06
---------------------------

این نسخه اصلی فقط برای کنترل بوردهای Beaglebone است.

*  دستگاه‌های Antminer

  * [feature] پشتیبانی اضافه شده برای کنترل بوردهای مبتنی بر BeagleBone (از جمله تیونر، اما به استثنای عملکرد ارتقاء خودکار)

**توجه:** این نسخه به جز ماینرهای مجهز به کنترل بورد Beaglebone اجرا نمی شود.

**توجه:** مطمئن نیستید کدام کنترل بورد را دارید؟ اینجا `بررسی کنید <https://braiins.com/blog/bitcoin-mining-control-board-variations>`_

22.05
---------------------------

این یک نسخه انتشار جزئی است که شامل منحنی‌های توان بهبود یافته برای مدل‌های منتخب Antminers است.

*  دستگاه‌های Antminer

  * [feature] ماتریس منحنی توان برای مدل‌های S19J و S19 pro اضافه شده است، بنابراین تخمین مصرف برق اکنون دقیق‌تر است.
