...
**Примечание:** Функция автоматического обновления имеет временную рандомизацию, чтобы предотвратить высокую пропускную способность на фермах. Это означает, что все устройства не будут обновляться одновременно. Автообновление проверяет наличие новой версии три раза в день.
